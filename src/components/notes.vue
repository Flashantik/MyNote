<template >
  <v-container id="contain">
    ...
    <v-dialog v-model="dialog" fullscreen transition="dialog-bottom-transition">
      <v-card style="overflow:hidden">
        <v-toolbar dark color="primary">
          ...
          <v-toolbar-title>Добавление записки
          </v-toolbar-title>
        </v-toolbar>
        <v-container>
          <v-layout row wrap>
            ...
            <v-flex xs12 sm10 md8 lg6 offset-sm1 offset-md2 offset-lg3 v-if="!seeCards" style="position:relative" key="1">
              ...
              <v-form v-model="valid" ref="form" validation>
                ...
                v => (v && v.length >= 10 && v.length <= 150) || 'Длинна описания должна быть от 10 до 150 символов']" v-model="notesDiscription"
                  required></v-textarea>
              </v-form>
              ...
              <v-list three-line subheader>
                ...
                <v-layout>
                  <v-btn color="warning" @click="trigUpload">Добавить изображение</v-btn>
                  <v-spacer></v-spacer>
                  <v-btn color="green" :disabled="!valid || loading" :loading="loading" @click="createNote">
                    Добавить</v-btn>
    ...
    <v-btn color="primary" @click="dialog=true">Добавить Notes</v-btn>
    <v-btn color="error" @click="settingsMode" >
    ...
    >
      ...
      :open-on-hover="true"
      transition="slide-x-reverse-transition"
      v-if='props.item.noteRatio.length != 0'
    >
      <v-btn 
        slot="activator"
        color="blue darken-2"
